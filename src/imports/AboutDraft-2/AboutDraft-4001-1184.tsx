import svgPaths from "./svg-iy5v808rx8";
...
function Container4() {
  return (
    <div className="bg-[#f8f7f4] h-[47.552px] relative shrink-0 w-full" data-name="Container">
...
function Text() {
  return (
    <div className="relative shrink-0 w-[36px]" data-name="Text">
...
function Text1() {
  return (
    <div className="h-[19.505px] relative shrink-0 w-[203.854px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container6() {
  return (
    <div className="absolute content-stretch flex gap-[15.998px] h-[62.552px] items-center left-0 pb-[16.556px] pl-[23.993px] pr-[24px] pt-[16px] top-0 w-[468.229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e8e4dc] border-b-[0.556px] border-solid inset-0 pointer-events-none" />
      <Text />
      <Text1 />
    </div>
...
function Text2() {
  return (
    <div className="relative shrink-0 w-[26px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
...
function Text3() {
  return (
    <div className="h-[19.505px] relative shrink-0 w-[176.519px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container7() {
  return (
    <div className="absolute content-stretch flex gap-[15.998px] h-[62.552px] items-center left-0 pb-[16.556px] pl-[23.993px] pr-[24px] pt-[16px] top-[62.55px] w-[468.229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e8e4dc] border-b-[0.556px] border-solid inset-0 pointer-events-none" />
      <Text2 />
      <Text3 />
    </div>
...
function Text4() {
  return (
    <div className="relative shrink-0 w-[76px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
...
function Text5() {
  return (
    <div className="h-[19.505px] relative shrink-0 w-[169.948px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container8() {
  return (
    <div className="absolute content-stretch flex gap-[15.998px] h-[62.552px] items-center left-0 pb-[16.556px] pl-[23.993px] pr-[24px] pt-[16px] top-[125.1px] w-[468.229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e8e4dc] border-b-[0.556px] border-solid inset-0 pointer-events-none" />
      <Text4 />
      <Text5 />
    </div>
...
function Text6() {
  return (
    <div className="relative shrink-0 w-[67px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
...
function Text7() {
  return (
    <div className="h-[19.505px] relative shrink-0 w-[142.656px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container9() {
  return (
    <div className="absolute content-stretch flex gap-[15.998px] h-[61.997px] items-center left-0 pl-[23.993px] pr-[24px] py-[16px] top-[187.66px] w-[468.229px]" data-name="Container">
      <Text6 />
      <Text7 />
    </div>
  );
...
function Container5() {
  return (
    <div className="h-[249.653px] relative shrink-0 w-full" data-name="Container">
      <Container6 />
      <Container7 />
      <Container8 />
      <Container9 />
...
function Container3() {
  return (
    <div className="bg-white h-[298.316px] relative rounded-[14px] shrink-0 w-[469.34px]" data-name="Container">
...
function Paragraph() {
  return (
    <div className="content-stretch flex gap-[42px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <Frame4 />
      <Container3 />
    </div>
  );
