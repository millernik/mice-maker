import svgPaths from "./svg-xz4o6tsil4";
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[520px]" data-name="Container">
      <p className="font-['Inter:Bold','Noto_Sans:Bold',sans-serif] font-bold leading-[60px] not-italic relative shrink-0 text-[#3f3f3f] text-[56px] w-full">{`Curious or already convinced? `}</p>
    </div>
  );
}
        ...
        <div className="content-stretch flex flex-col gap-[10px] items-start px-[50px] py-[100px] relative size-full">
          ...
          <div className="-translate-y-1/2 absolute h-[282px] left-[860px] top-1/2 w-[253px]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 253 282">
              <path d={svgPaths.p3678c600} id="Vector" stroke="url(#paint0_linear_1_1664)" />
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1664" x1="244.567" x2="5.76524" y1="25.0161" y2="270.567">
  ...
  return (
    <div className="bg-[#c6a56b] drop-shadow-[0px_2px_8px_rgba(198,165,107,0.35)] relative rounded-[10px] shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] items-center px-[24px] py-[12px] relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[21px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">{`Send Enquiry `}</p>
        <Icon />
      </div>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[#c6a56b] h-[44.097px] relative rounded-[9px] shrink-0 w-[103.698px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[19.5px] left-[52.5px] not-italic text-[13px] text-center text-white top-[12.96px] whitespace-nowrap">Subscribe</p>
      </div>
    </div>
  );
}
