import svgPaths from "./svg-knq4q6scw2";
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col gap-[26px] items-start not-italic relative shrink-0 w-[880px]" data-name="Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[60px] relative shrink-0 text-[#3f3f3f] text-[56px] w-full">{`Finding hotel rooms for medical congresses isn't easy.`}</p>
      <div className="font-['Inter:Regular','Noto_Sans_Symbols2:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#6b6b6b] text-[17px] w-full whitespace-pre-wrap">
        <p className="leading-[29.75px] mb-0">{`Most hotels are blocked years in advance.What’s left is limited. Or overpriced. `}</p>
        <p className="leading-[29.75px]">{`And sometimes simply gone. `}</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#f0eadf] relative shrink-0 w-full" data-name="Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start px-[50px] py-[100px] relative size-full">
          <Container1 />
          <div className="-translate-y-1/2 absolute h-[363px] left-[953px] top-[calc(50%-0.5px)] w-[326px]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 326 363">
              <path d={svgPaths.p1dffb400} id="Vector" stroke="url(#paint0_linear_1_1630)" />
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1630" x1="315.133" x2="7.74884" y1="32.2016" y2="348.594">
...
function Paragraph() {
  return (
    <div className="content-stretch flex font-['Inter:Regular','Noto_Sans:Regular',sans-serif] font-normal gap-[42px] items-start leading-[0] relative shrink-0 text-[#6b6b6b] text-[16px] w-full whitespace-pre-wrap" data-name="Paragraph">
      <div className="flex-[1_0_0] min-w-px relative">
        <p className="leading-[29.6px] mb-0">{`MICE MAKER secures hotel contingents for major medical congresses across Europe. `}</p>
        <p className="leading-[29.6px] mb-0">{`Depending on your setup, we offer different ways of working – from full service booking to transparent sourcing models. `}</p>
        <p className="leading-[29.6px] mb-0">​</p>
        <p className="leading-[29.6px]">{`For short-notice requests, our network and experience give access to remaining availability where others can’t. `}</p>
      </div>
      <div className="relative self-stretch shrink-0 w-[649px]">
        <p className="leading-[29.6px] mb-0">{`Over 12 years of MICE MAKER, backed by 25 years of industry experience. `}</p>
        <p className="leading-[29.6px] mb-0">{`Working with international agencies and pharmaceutical clients in high-demand environments. `}</p>
        <p className="leading-[29.6px] mb-0">​</p>
        <p className="leading-[29.6px] mb-0">{`If you’ve worked in this space, you know how complex it can get. `}</p>
        <p className="leading-[29.6px]">{`We keep it simple. `}</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col gap-[50px] items-start justify-end not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Extra_Bold','Noto_Sans:Black',sans-serif] font-extrabold leading-[44.8px] relative shrink-0 text-[#3f3f3f] text-[40px] tracking-[-0.88px] whitespace-nowrap">{`That´s where we come in! `}</p>
      <Paragraph />
    </div>
  );
}
...
export default function AboutDraft() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="About Draft">
      <Navigation />
      <Section />
      <Section1 />
      <FooterAlternativ />
